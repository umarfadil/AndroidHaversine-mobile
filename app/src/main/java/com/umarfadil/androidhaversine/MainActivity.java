package com.umarfadil.androidhaversine;
...
import com.umarfadil.androidhaversine.adapter.CustomListAdapter;
...
public class MainActivity extends AppCompatActivity implements LocationListener,
    ...
    private static final String url = "http://192.168.100.12/AndroidHaversine/haversine.php?lat=";
    ...
    private void lokasi() {
        ...
        if (location != null) {
           ...
           /* latitude longitude Alun-alun Demak sebagai default jika tidak ditemukan lokasi dari device pengguna */
            callListVolley(-7.2942139, 112.7749522);
        }
    }
